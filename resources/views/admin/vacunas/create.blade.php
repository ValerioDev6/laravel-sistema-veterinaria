        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h4 class="card-title mb-0"><i class="ri-virus-line me-1 text-primary"></i>Registrar Vacuna</h4>
                    <span class="badge bg-success-subtle text-success">Vacunación con pago</span>
                </div>
                <div class="card-body">
                    <form id="formCrearVacuna" class="row g-3">
                        {{-- 1. Fecha (disparador de disponibilidad) --}}
                        <div class="col-md-4">
                            <label class="form-label" for="vaccination_date">Fecha de vacunación</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="ri-calendar-line"></i></span>
                                <input type="date" class="form-control" id="vaccination_date" name="vaccination_date" min="{{ now()->toDateString() }}" required>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div id="bloqueDisponibilidad" class="d-none">
                                ...
                                <input type="hidden" name="vaccination_time" id="vaccination_time">
                            </div>
                        </div>
