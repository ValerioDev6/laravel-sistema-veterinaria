                    ...
                    <form id="formCrearService">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Ej. Consulta general">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control" id="base_price" name="base_price" placeholder="0.00">
                                <div class="invalid-feedback"></div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="duration_minutes">Duración (minutos)</label>
                                <input type="number" min="1" class="form-control" id="duration_minutes" name="duration_minutes" value="30">
                                <div class="invalid-feedback"></div>
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary" id="btnGuardarService">
