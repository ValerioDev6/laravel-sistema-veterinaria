        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Editar Raza</h4>
                </div>
                <div class="card-body">
                    <form id="formEditarBreed" data-id="{{ $breed->id }}">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="species_id" name="species_id">
                                ...
                                @foreach ($species as $value => $label)
                                    <option value="{{ $value }}" @selected($breed->species_id == $value)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary" id="btnActualizarBreed">
