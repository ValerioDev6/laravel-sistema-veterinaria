<x-app-layout>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Editar Cirugía #{{ $cirugia->id }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h4 class="card-title mb-0"><i class="ri-scissors-line me-1 text-primary"></i>Editar Cirugía #{{ $cirugia->id }}</h4>
                    <span class="badge bg-success-subtle text-success">Cirugía con pago</span>
                </div>
                <div class="card-body">
                    <form id="formEditarCirugia" data-id="{{ $cirugia->id }}" class="row g-3">
                        {{-- 1. Fecha (disparador de disponibilidad) --}}
                        <div class="col-md-4">
                            <label class="form-label" for="surgery_date">Fecha de la cirugía</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="ri-calendar-line"></i></span>
                                <input type="date" class="form-control" id="surgery_date" name="surgery_date" value="{{ $cirugia->surgery_date?->format('Y-m-d') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="surgery_type" name="surgery_type" value="{{ $cirugia->surgery_type }}" placeholder="Ej. Esterilización">
                            </div>
                            <div class="invalid-feedback"></div>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" min="0" class="form-control" id="total_pago" name="total" value="{{ number_format($invoice?->total ?? 0, 2, '.', '') }}" required>
                                        </div>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-md-4">
    ...
    @push('scripts')
        <script>
            ...
            window.cirugiaEditarInit = {
                veterinario: {{ $cirugia->veterinarian_id }},
                hora: "{{ $cirugia->surgery_date?->format('H:i') }}",
            };
        </script>
