        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Editar Vacuna</h4>
                </div>
                <div class="card-body">
                    <form id="formEditarVacuna" data-id="{{ $vacuna->id }}">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="vaccine_type_id" name="vaccine_type_id">
                                    ...
                                    @foreach ($vaccineTypes as $value => $label)
                                        <option value="{{ $value }}" @selected($vacuna->vaccine_type_id == $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="veterinarian_id" name="veterinarian_id">
                                    ...
                                    @foreach ($veterinarians as $value => $label)
                                        <option value="{{ $value }}" @selected($vacuna->veterinarian_id == $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="cita_id" name="cita_id">
                                    ...
                                    @foreach ($citas as $value => $label)
                                        <option value="{{ $value }}" @selected($vacuna->cita_id == $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="vaccination_date" name="vaccination_date" value="{{ $vacuna->vaccination_date?->format('Y-m-d') }}">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6 mb-3">
